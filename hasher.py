...
hasher__last_update = '19.08.2020'
hasher__version = '4.0'

##-import
from hashlib import *

# from modules.base.console.color impor6t color, cl_out, c_output, cl_inp, c_succes, c_wrdlt, c_error, c_prog, c_ascii
# from modules.base.base_functions import inp_lst, set_prompt
from base_funcs import inp_lst, set_prompt
