...
from base_funcs import list_files
...
class TextEditor(QWidget):
    ...
    def __init__(self, txt_width=500, txt_height=220, txt_text=('Text :'), parent=None):
        ...
        self.bt_clear.setMaximumSize(len(('Clear'))*13, 50)
        ...
        self.bt_select.setMaximumSize(len(('Select a file ...'))*13, 50)
        ...
        self.bt_select_load.setMaximumSize((len(('Select and load'))+2)*13, 50)
    ...
    def load_fn(self):
        ...
        if type(file_content) == str:
            ...
            try:
                ...
                QMessageBox.critical(None, '!!! ' + ('Decoding error') + ' !!!', '<h2>' + ("The file can't be decoded in bytes mode") + '!</h2>')
                return -2
